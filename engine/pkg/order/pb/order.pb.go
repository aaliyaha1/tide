...
var file_order_proto_goTypes = []interface{}{
	(*CreateOrderRequest)(nil),  // 0: mm.CreateOrderRequest
	(*CreateOrderResponse)(nil), // 1: mm.CreateOrderResponse
}
var file_order_proto_depIdxs = []int32{
	0, // 0: mm.OrderService.CreateOrder:input_type -> mm.CreateOrderRequest
	1, // 1: mm.OrderService.CreateOrder:output_type -> mm.CreateOrderResponse
